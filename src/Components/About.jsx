  ...
  return (
      ...
      <section className="my-8 flex flex-row items-center justify-between px-3">
        ...
        <div className="hidden md:block">
          <img className="h-[200px] w-[200px] object-contain rounded-full" src="https://res.cloudinary.com/dj1awovlx/image/upload/v1740140119/IMG_20250221_174234_eanfaa.jpg" alt=""/>
        </div>
      </section>
