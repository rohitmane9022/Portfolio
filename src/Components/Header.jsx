...
export default function Header() {
  return (
    <header>
      ...
      <Link to="https://github.com/rohitmane9022" target="_black" className="rounded-lg bg-zinc-800 p-2 text-2xl ring-zinc-500 hover:ring-2 transition-all duration-200">
